 ...
 *
 *  Date: 2000-12-02
 *  Date: June 2005  JDPoirier   Cosemetic changes. Added __LP64__ check for defining
 *                               __WORDSIZE so there're no external header file
 *                               dependencies. WCHAR min/max changes. WINT_MIN
 *                               and WINT_MAX to signed values.
 */
#ifndef _STDINT_H
#define _STDINT_H
...
/*
 * wint_t is unsigned int in __MINGW32__, but unsigned short in MS runtime
 * JDP: changed to signed values
 */
